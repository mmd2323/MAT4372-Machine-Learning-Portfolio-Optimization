...
## Tools and Packages
- R
  - `quantmod` – fetch stock prices  
  - `TTR` – compute weekly returns  
  - `PerformanceAnalytics` – calculate Sharpe ratio and volatility  
  - `randomForest` – model and predict Sharpe ratios  
...
## Results
The efficient frontier was successfully reconstructed using machine learning, producing realistic portfolio configurations that align with modern portfolio theory principles while avoiding restrictive assumptions such as normality of returns.
...
- Incorporate macroeconomic indicators or sentiment data for broader predictive insights.
